...
$\unicode[goombafont; color:black; pointer-events: none; z-index: 10; position: fixed; top: 50vh; left: 50vw; width: 50px; height: 50px; background-color: black; transform: translate(-50%, -50%);
]{x0001}$
}
