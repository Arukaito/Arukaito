...
$\unicode[goombafont; color:black; pointer-events: none; z-index: -9; position: fixed; top: 30vh; left: 20vw; width: 50vh; height: 50px; background-color: black; transform: translate(-50%, -50%);
]{x0001}$
}
