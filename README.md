...
$\unicode[goombafont; color:black; pointer-events: none; z-index: -9; position: fixed; top: 20vh; left: 50vw; width: 112vh; height: 120vh;opacity: 0.4;  background-color: black; transform: translateX(-50%);
]{x0001}$
}
