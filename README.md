...
$\unicode[goombafont; color:black; pointer-events: none; z-index: -9; position: fixed; top: 20vh; left: 50vw; width: 160vh; height: 100vh;opacity: 0.4;  background-color: black; transform: translate(-50%, -50%);
]{x0001}$
}
