...
$\unicode[goombafont; color:black; pointer-events: none; z-index: -9; position: fixed; top: 20vh; left: 50vw; width: 60vh; height: 100vh; background-color: black; transform: translate(-50%, -50%);
]{x0001}$
}
